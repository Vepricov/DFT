...
MODEL_NAME_OR_PATH="${MODEL_NAME_OR_PATH:-$ROOT_DIR/merged/qwen15b-sft-lora-r8-a16}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/math_evaluation/outputs/paper_qwen15b_sft_lora}"

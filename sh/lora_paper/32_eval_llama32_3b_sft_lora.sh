...
MODEL_NAME_OR_PATH="${MODEL_NAME_OR_PATH:-$ROOT_DIR/merged/llama32-3b-sft-lora-r8-a16}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/math_evaluation/outputs/paper_llama32_3b_sft_lora}"
